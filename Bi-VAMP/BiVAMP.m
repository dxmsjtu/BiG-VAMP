...
%   v      :   estimated V matrix
    ...
    switch     params.prior_u
        ...
        case    {'Bernoulli-Gauss'}
            sparsity = params.prior_u_option.rho;            u=randn(m,r).*(rand(m,r)<sparsity);            
            mu_u_gauss_update = zeros(m,r);            gamma_u_gauss_update = ones(1,r);            
            mu_u_ext_old = zeros(m,r);            gamma_u_ext_old = ones(1,r);
        otherwise
    ...
    switch     params.prior_v
        ...
        case    {'Bernoulli-Gauss'}
            v = randn(n,r);
            mu_v_gauss_update = zeros(n,r);            gamma_v_gauss_update = ones(1,r);            
    ...
    while ((diff>params.conv_criterion))&&(t<params.nb_iter)
        ...
        A_u_old = A_u;      A_v_old = A_v;        B_u_old = B_u;      B_v_old = B_v;        
        ...
        mu_v_ext_old = mu_v_ext;        gamma_v_ext_old = gamma_v_ext;        
        ...
        switch     params.prior_u
            ...
            case    {'Bernoulli-Gauss'}
                [u_est, mu_u_gauss_update, gamma_u_gauss_update] = prior_bernoulli_gauss(mu_u_ext,gamma_u_ext, 1, params.prior_u_option.rho);
        end        
        ...
        switch     params.prior_v
            case    {'Gauss'}
                % do nothing
            case    {'Bernoulli-Gauss'}
                [v_est, mu_v_gauss_update, gamma_v_gauss_update] = prior_bernoulli_gauss(mu_v_ext,gamma_v_ext, 1, params.prior_v_option.rho);
        end        
